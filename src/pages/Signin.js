                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-col gap-2">
                                ...
                                <input onChange={handleEmail}
                                    value={email} className="w-full lowercase py-1 font-titleFont border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100" type="email"
                                />
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input onChange={handlePassword}
                                    value={password} className="w-full lowercase py-1 border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100" type="password"
                                />
