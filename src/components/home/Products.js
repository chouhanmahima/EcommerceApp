...
const Products = () => {
    ...
    return (
        <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 xl:gap-10 gap-4 px-4'>
                ...
                <div key={(item.id)} className='bg-white h-auto border-[1px] border-gray-200 py-8 z-30 hover:border-transparent shadow-none hover:shadow-testShadow duration-200 relative flex flex-col gap-4'>
                    ...
                    <div className='px-4 z-10 bg-white'>
                        ...
                        <div className='flex items-center justify-between'>
                            <h2 className='font-titleFont tracking-wide text-lg font-medium text-amazon_blue'>{item.title.substring(0, 20)}</h2>
                        ...
                        <div>
                            <button onClick={()=>dispatch(addToCart({
                                ...
                                image: item.image,
                                quantity: 1,
                            }))} className='w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 hover:from-yellow-300 hover:to-yellow-400 border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded md-3'>Add to Cart</button>
                        </div>
